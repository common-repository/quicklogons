...
if(!class_exists("QuicklogonsPlugin"))
{
    ...
    class QuicklogonsPlugin
    {
        ...
        {
            load_plugin_textdomain('quicklogons', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
        }
        ...
        function land_on()
        {
            ...
            if (!isset($response->error) || $response->error == "")
            {
                ...
                if (!$user)
                {
                    ...
                    else $response->error = __("Wordpress can't create user", "quicklogons");
                }
                if ($user)
                {
        ...
        {
            add_options_page(__('Settings', 'quicklogons'), __('Quicklogons', 'quicklogons'), 'manage_options', 'quicklogons_plugin', array(&$this, 'plugin_settings_page'));
        }
